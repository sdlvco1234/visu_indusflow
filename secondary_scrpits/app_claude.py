...
# Un peu de style pour rendre les metrics plus lisibles
st.markdown(
    """
    <style>
...
st.sidebar.divider()
st.sidebar.caption("Sélectionnez une direction dans les onglets ci-dessus pour accéder à sa vue dédiée.")
...
DG, Resp_usines, Dir_maintenance, DAF, Dir_Com = st.tabs(
    ["📊 Direction Générale", "🏭 Direction d'usines", "🔧 Direction de Maintenance",
    ...
    with tab_couts:
        ...
        if df_all_costs_facto is None:
            st.warning(
                ...
                "Ajoute-la à ton ETL (voir la note fournie) pour afficher la décomposition des coûts par usine."
            )
        else:
...
# ============================================================================
# ONGLET 3 — DIRECTION DE MAINTENANCE
# ============================================================================

with Dir_maintenance:
...
# ============================================================================
# ONGLET 5 — DIRECTION COMMERCIALE
# ============================================================================
